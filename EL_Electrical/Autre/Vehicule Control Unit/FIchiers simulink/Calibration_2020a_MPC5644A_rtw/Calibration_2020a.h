...
typedef struct {
  uint8_T PackSignalsToCANData[8];     /* '<S30>/Pack Signals To CAN Data' */
...
extern __MP uint8_T demo_trq;          /* '<S30>/Constant' */
 ...
 * '<S31>'  : 'Calibration_2020a/Speed CAN/Subsystem/Write Measurement'
 */
