...
__MP uint8_T demo_trq;                 /* '<S30>/Constant' */
...
void Calibration_2020a_step5(void)     /* Sample time: [0.1s, 0.0s] */
{
  ...
  B_n.PackSignalsToCANData[0] = (uint8_T)((uint8_T)((demo_trq & 0xFF)));
  B_n.PackSignalsToCANData[1] = (uint8_T)(0);
  B_n.PackSignalsToCANData[2] = (uint8_T)(0);
  ...
  F_ASW_CAN_Tx(CAN_CTRL_A, 0, 0,257,2,(ECO_U08 *)(&B_n.PackSignalsToCANData[0]));
   ...
   */
  F_ASW_CAN_Tx(CAN_CTRL_A, false, false,261U,((uint8_T)1U),(ECO_U08 *)
               (&B_n.PackSignalsToCANData[0]));
