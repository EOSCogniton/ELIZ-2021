...
__MP int16_T vitesse;                  /* '<S32>/Unpack CAN Data To Signals' */
...
RT_MODEL M_;
RT_MODEL *const M = &M_;
void Speed_CAN_2020a_step0(void);
void Speed_CAN_2020a_step1(void);
void Speed_CAN_2020a_step2(void);
void Speed_CAN_2020a_step3(void);
void Speed_CAN_2020a_step4(void);
void Speed_CAN_2020a_step5(void);
void Speed_CAN_2020a_step6(void);
void Speed_CAN_2020a_step7(void);
void Speed_CAN_2020a_step8(void);
uint8_T EcoCoder_Target_Setting;

/* Model step function for TID0 */
void Speed_CAN_2020a_step0(void)       /* Sample time: [0.001s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID1 */
void Speed_CAN_2020a_step1(void)       /* Sample time: [0.005s, 0.0s] */
{
...
void Speed_CAN_2020a_step2(void)       /* Sample time: [0.01s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID3 */
void Speed_CAN_2020a_step3(void)       /* Sample time: [0.02s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID4 */
void Speed_CAN_2020a_step4(void)       /* Sample time: [0.05s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID5 */
void Speed_CAN_2020a_step5(void)       /* Sample time: [0.1s, 0.0s] */
{
  ...
  /* Output and update for function-call system: '<S3>/Subsystem' */
  {
    ...
    B_n.ReadADCValue = F_Abstr_ADC_GetValue(ABS_ADC_19);

    /* DeadZone: '<S30>/Dead Zone' incorporates:
     *  DataTypeConversion: '<S30>/Data Type Conversion'
     */
    if (B_n.ReadADCValue > 5) {
      tmp = (real32_T)B_n.ReadADCValue - 5.0F;
    } else {
      tmp = 0.0F;
    }
     ...
     *  Gain: '<S30>/Gain'
     */
    B_n.DataTypeConversion2 = (int16_T)(real32_T)floor(7.99975586F * tmp);
    ...
    B_n.PackSignalsToCANData_o[0] = (uint8_T)((uint8_T)((((uint8_T)49U) & 0xFF)));
    B_n.PackSignalsToCANData_o[1] = (uint8_T)((uint8_T)((B_n.DataTypeConversion2
      & 0xFF)));
    B_n.PackSignalsToCANData_o[2] = (uint8_T)((uint8_T)((B_n.DataTypeConversion2
      & 0xFF00)>>8U));
    ...
    F_ASW_CAN_Tx(CAN_CTRL_A, 0, 0,513,3,(ECO_U08 *)(&B_n.PackSignalsToCANData_o
      [0]));
  }

  /* End of Outputs for S-Function (EcoCoder_Task): '<S3>/Task Trigger' */

  /* S-Function (EcoCoder_Task): '<S3>/Task Trigger2' */

  /* -- Call CAN RX Fcn-Call_0 -- */

  /* Output and update for function-call system: '<S3>/Subsystem2' */

  /* S-Function (ecocoder_receive_msg): '<S32>/Receive CAN Message' */
  B_n.ReceiveCANMessage_o1= F_ASW_CAN_Rx(&SvcCANDrtSlt0x181_0_0_1U, (ECO_BOOL *)
    &B_n.ReceiveCANMessage_o2, (ECO_BOOL *)&B_n.ReceiveCANMessage_o3,(ECO_U32 *)
    &B_n.ReceiveCANMessage_o4,(ECO_U08 *)&B_n.ReceiveCANMessage_o5,(ECO_U08 *)
    &B_n.ReceiveCANMessage_o6[0]);

  /* S-Function (CoderCAN_UnpackData2Bit): '<S32>/Unpack CAN Data To Signals' */

  /* --------------- Start unpack signal from message -----------------------------
     The number of signals is 3
     ------------------------------------------------------------------------------------------------------------------------------------------------------------*/
  /**********Unpack signal 0:startBit= 0U length = 8U byteOrder = LITTLEENDIAN dataType= uint8_T**********/
  B_n.UnpackCANDataToSignals_o1 = (uint8_T)(
    ((uint8_T)(B_n.ReceiveCANMessage_o6[0] ) )
    );

  /**********Unpack signal 1:startBit= 8U length = 16U byteOrder = LITTLEENDIAN dataType= int16_T**********/
  vitesse = (int16_T)(
                      ((int16_T)(B_n.ReceiveCANMessage_o6[1] ) )
                      | ((int16_T)(B_n.ReceiveCANMessage_o6[2] ) <<8U )
                      );

  /**********Unpack signal 2:startBit= 24U length = 8U byteOrder = LITTLEENDIAN dataType= uint8_T**********/
  B_n.UnpackCANDataToSignals_o3 = (uint8_T)(
    ((uint8_T)(B_n.ReceiveCANMessage_o6[3] ) )
    );

  /* --------------- End unpack signal from message ------------------------------------------------------------------------------------------
     --------------------------------------------------------------------------------*/

  /* End of Outputs for S-Function (EcoCoder_Task): '<S3>/Task Trigger2' */
}

/* Model step function for TID6 */
void Speed_CAN_2020a_step6(void)       /* Sample time: [0.2s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID7 */
void Speed_CAN_2020a_step7(void)       /* Sample time: [0.5s, 0.0s] */
{
  /* (no output/update code required) */
}

/* Model step function for TID8 */
void Speed_CAN_2020a_step8(void)       /* Sample time: [1.0s, 0.0s] */
{
  /* (no output/update code required) */
}
...
void Speed_CAN_2020a_step(int_T tid)
{
  switch (tid) {
   case 0 :
    Speed_CAN_2020a_step0();
    break;

   case 1 :
    Speed_CAN_2020a_step1();
    break;

   case 2 :
    Speed_CAN_2020a_step2();
    break;

   case 3 :
    Speed_CAN_2020a_step3();
    break;

   case 4 :
    Speed_CAN_2020a_step4();
    break;

   case 5 :
    Speed_CAN_2020a_step5();
    break;

   case 6 :
    Speed_CAN_2020a_step6();
    break;

   case 7 :
    Speed_CAN_2020a_step7();
    break;

   case 8 :
    Speed_CAN_2020a_step8();
    break;
...
void Speed_CAN_2020a_initialize(void)
{
  ...
  /* Start for S-Function (EcoCoder_Task): '<S3>/Task Trigger1' */

  /* -- Call CAN RX Fcn-Call_0 -- */

  /* Output and update for function-call system: '<S3>/Subsystem1' */
  ...
  B_n.PackSignalsToCANData[0] = (uint8_T)((uint8_T)((((uint8_T)61U) & 0xFF)));
  B_n.PackSignalsToCANData[1] = (uint8_T)((uint8_T)((((uint8_T)48U) & 0xFF)));
  B_n.PackSignalsToCANData[2] = (uint8_T)((uint8_T)((((uint8_T)100U) & 0xFF)));
  ...
  F_ASW_CAN_Tx(CAN_CTRL_A, 0, 0,513,3,(ECO_U08 *)(&B_n.PackSignalsToCANData[0]));

  /* End of Start for S-Function (EcoCoder_Task): '<S3>/Task Trigger1' */
