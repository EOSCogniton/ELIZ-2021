...
extern CANDirectSlot_t CANDirectSlotMsgElemenB[1U];
extern CANDirectSlot_t CANDirectSlotMsgElemenC[1];

#define SvcCANDrtSlt0x181_0_0_1U       CANDirectSlotMsgElemenA[0]
#define ServiceCANDirectSlot0x100_0_can1 CANDirectSlotMsgElemenB[0]
