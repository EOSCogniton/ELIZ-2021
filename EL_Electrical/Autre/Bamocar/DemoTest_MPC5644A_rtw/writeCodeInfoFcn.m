% Autogenerated file: Thu Feb  3 17:31:57 2022
function writeCodeInfoFcn


% Load a ComponentInterface object from IR
codeIRInfoStruct = load('C:\Users\Thibault NOUVELLON\Documents\EPSA\Github\ELIZ-2021\EL_Electrical\Autre\Bamocar\DemoTest_MPC5644A_rtw\tlc\codeIRInfo.mat');
...
wr = coder.internal.writeMF0DataInterfacesToCodeDescriptor("DemoTest","C:\Users\Thibault NOUVELLON\Documents\EPSA\Github\ELIZ-2021\EL_Electrical\Autre\Bamocar\DemoTest_MPC5644A_rtw") ;
...
Var_PwrM_flgKeyOnDelay = RTW.Variable(Type_8_R0_V0_C0, 'PwrM_flgKeyOnDelay');
    Var_PwrM_flgKeyOnDelay.Owner           = 'DemoTest';
    Var_PwrM_flgKeyOnDelay.DeclarationFile = 'DemoTest.h';
    Var_PwrM_flgKeyOnDelay.DefinitionFile  = 'DemoTest.c';
    
                 
             Var_PwrM_flgKeyOnDelay.StorageSpecifier = 'extern';
            Var_PwrM_flgKeyOnDelay.CodeType = Type_8_R0_V0_C0;
            wr.writeExternalBlockOutput(Var_PwrM_flgKeyOnDelay, 0);
...
Var_PwrM_flgKeyOnRaw = RTW.Variable(Type_8_R0_V0_C0, 'PwrM_flgKeyOnRaw');
    Var_PwrM_flgKeyOnRaw.Owner           = 'DemoTest';
    Var_PwrM_flgKeyOnRaw.DeclarationFile = 'DemoTest.h';
    Var_PwrM_flgKeyOnRaw.DefinitionFile  = 'DemoTest.c';
    
                 
             Var_PwrM_flgKeyOnRaw.StorageSpecifier = 'extern';
            Var_PwrM_flgKeyOnRaw.CodeType = Type_8_R0_V0_C0;
            wr.writeExternalBlockOutput(Var_PwrM_flgKeyOnRaw, 1);
...
tmpActualReturn = RTW.DataInterface.empty;
  ...
  func_Initialize_Prototype.Return     = tmpRet;
    func_Initialize_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_Initialize_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_Initialize_Interface.ActualReturn = tmpActualReturn;
      ...
      func_Initialize_Prototype.Name = 'DemoTest_initialize';
...
Const_TID0 = RTW.DataInterface('', 'TID0', Lit_0, empty_timing);
  ...
  func_OutputUpdate0_Prototype.Return     = tmpRet;
    func_OutputUpdate0_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate0_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate0_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate0_Prototype.Name = 'DemoTest_step';
  time_0 = codeInfo.TimingProperties(getIndexFromTimingInternalId(codeInfo.TimingInternalIds, 0));
...
Const_TID1 = RTW.DataInterface('', 'TID1', Lit_1, empty_timing);
  ...
  func_OutputUpdate1_Prototype.Return     = tmpRet;
    func_OutputUpdate1_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate1_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate1_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate1_Prototype.Name = 'DemoTest_step';
...
Const_TID2 = RTW.DataInterface('', 'TID2', Lit_2, empty_timing);
  ...
  func_OutputUpdate2_Prototype.Return     = tmpRet;
    func_OutputUpdate2_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate2_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate2_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate2_Prototype.Name = 'DemoTest_step';
...
Const_TID3 = RTW.DataInterface('', 'TID3', Lit_3, empty_timing);
  ...
  func_OutputUpdate3_Prototype.Return     = tmpRet;
    func_OutputUpdate3_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate3_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate3_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate3_Prototype.Name = 'DemoTest_step';
...
Const_TID4 = RTW.DataInterface('', 'TID4', Lit_4, empty_timing);
  ...
  func_OutputUpdate4_Prototype.Return     = tmpRet;
    func_OutputUpdate4_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate4_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate4_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate4_Prototype.Name = 'DemoTest_step';
...
Const_TID5 = RTW.DataInterface('', 'TID5', Lit_5, empty_timing);
  ...
  func_OutputUpdate5_Prototype.Return     = tmpRet;
    func_OutputUpdate5_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate5_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate5_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate5_Prototype.Name = 'DemoTest_step';
...
Const_TID6 = RTW.DataInterface('', 'TID6', Lit_6, empty_timing);
  ...
  func_OutputUpdate6_Prototype.Return     = tmpRet;
    func_OutputUpdate6_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate6_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate6_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate6_Prototype.Name = 'DemoTest_step';
...
Const_TID7 = RTW.DataInterface('', 'TID7', Lit_7, empty_timing);
  ...
  func_OutputUpdate7_Prototype.Return     = tmpRet;
    func_OutputUpdate7_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate7_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate7_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate7_Prototype.Name = 'DemoTest_step';
...
Const_TID8 = RTW.DataInterface('', 'TID8', Lit_8, empty_timing);
  ...
  func_OutputUpdate8_Prototype.Return     = tmpRet;
    func_OutputUpdate8_Prototype.HeaderFile = ['DemoTest', '.h'];
  func_OutputUpdate8_Prototype.SourceFile = ['DemoTest', '.c'];
  ...
  func_OutputUpdate8_Interface.ActualReturn = tmpActualReturn;
        ...
        func_OutputUpdate8_Prototype.Name = 'DemoTest_step';
