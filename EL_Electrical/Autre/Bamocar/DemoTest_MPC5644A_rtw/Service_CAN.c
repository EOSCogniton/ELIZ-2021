...
CANMsgElement_t canMsgElement1[2];
...
CANDirectSlot_t CANDirectSlotMsgElemenA[1];
CANDirectSlot_t CANDirectSlotMsgElemenB[1];
CANDirectSlot_t CANDirectSlotMsgElemenC[1U];
CANDirectSlotElementPrt_t CANDirectSlotMsgElementPrt[NUM_CANRx_CHANNEL]= {
  { CANDirectSlotMsgElemenA, 0U },

  { CANDirectSlotMsgElemenB, 0U },

  { CANDirectSlotMsgElemenC, 1U },
};
...
void F_Servece_CAN_Update_H1ms(void)
{
  ...
  if (1==F_Servece_CAN_ReceiveDirect(&ServiceCANDirectSlot0x100_0_can2,
       &messageObj)) {
...
void F_Servece_CAN_Init(void)
{
  ...
  /**************************ServiceCANDirectSlot0x100_0_can2*************************************/
  ServiceCANDirectSlot0x100_0_can2.messageObj.id= 0x100;
  ServiceCANDirectSlot0x100_0_can2.messageObj.extended= 0;
  ServiceCANDirectSlot0x100_0_can2.messageObj.length= 8;
  ServiceCANDirectSlot0x100_0_can2.messageObj.remote= 0;
  ServiceCANDirectSlot0x100_0_can2.ready= 0;
  ServiceCANDirectSlot0x100_0_can2.read= 0;
  ServiceCANDirectSlot0x100_0_can2.write= 0;
